...
public unsafe partial class Program
{
    ...
    public static readonly NetworkConfig ConfigV8 = new()
    {
        ...
        FC1ForwardKernelName = "pool2_forward",
        FC1BackwardKernelName = "pool2_backward",
        FC1BackwardWeightsKernelName = "fc1_backward",
        UsesPooledConv2AsFc1Input = true,
        FC1OutputElementsOverride = 784,
        FC2InputsOverride = 784,
        RequiresIntermediateGradBuffer = true,
        UseCustomEvaluationPath = true,
        BatchSize = 256,
        Conv1FilterCount = 16,
        Conv1FilterSize = 3,
        Conv2FilterCount = 16,
